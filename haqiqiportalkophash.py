    ...
    try:
        ...
        for gid, mode in giv_ids_ozim:
            ...
            if req["is_already_participating"]:
                ...
                requests.post(f"https://portals-market.com/api/giveaways/{giveaway_code}/join", proxies=proxies, headers=headers, timeout=10)

                req_after = requests.get(f"https://portals-market.com/api/giveaways/{giveaway_code}/requirements", proxies=proxies, headers=headers, timeout=10)
